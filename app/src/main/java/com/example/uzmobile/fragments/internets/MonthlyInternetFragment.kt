...
import com.example.uzmobile.databinding.FragmentMonthlyInternetBinding
import com.example.uzmobile.databinding.FragmentMonthlyMinuteBinding
import com.example.uzmobile.fragments.HomeFragment

class MonthlyInternetFragment : Fragment(R.layout.fragment_monthly_internet) {

    private var _binding: FragmentMonthlyInternetBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentMonthlyInternetBinding.bind(view)
    ...
    private fun initList() {
        ...
        categories.add("100 MB")
        categories.add("150 MB")
        categories.add("500 MB")
        categories.add("1000 MB ")
        categories.add("2 GB")
    }
