...
class UssdCodeExpandableFragment : Fragment(R.layout.fragment_ussd_code_expandable) {
    private var _binding: FragmentUssdCodeExpandableBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentUssdCodeExpandableBinding.bind(view)
    ...
    private fun initList() {
        ...
        categories.add("Balans")
        categories.add("Mening raqamim")
        categories.add("Menga qongiroq qiling")
        categories.add("Boshqa raqamga yo’naltirish")
        categories.add("Vaqtincha aloqada emasman")
        categories.add("Ko’ngilochar chat")
        categories.add("Men kimman")
        categories.add("Mega boom")
    }
