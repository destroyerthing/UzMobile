...
class WeeklyMinuteTwoFragment : Fragment(R.layout.fragment_weekly_minute_two) {
    private var _binding: FragmentWeeklyMinuteTwoBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentWeeklyMinuteTwoBinding.bind(view)
    ...
    private fun initList() {
        ...
        categories.add("90 daqiqa")
        categories.add("100 daqiqa")
        categories.add("110 daqiqa")
        categories.add("120 daqiqa")
        categories.add("130 daqiqa ")
        categories.add("140 daqiqa")
    }
