...
import com.example.uzmobile.databinding.FragmentDailySmsBinding
...
class DailySmsFragment : Fragment(R.layout.fragment_daily_sms) {


    private var _binding: FragmentDailySmsBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentDailySmsBinding.bind(view)
