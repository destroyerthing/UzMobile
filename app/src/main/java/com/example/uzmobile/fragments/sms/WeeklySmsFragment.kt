...
import com.example.uzmobile.databinding.FragmentWeeklySmsBinding
import com.example.uzmobile.fragments.HomeFragment


class WeeklySmsFragment : Fragment(R.layout.fragment_weekly_sms) {
    private var _binding: FragmentWeeklySmsBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentWeeklySmsBinding.bind(view)
