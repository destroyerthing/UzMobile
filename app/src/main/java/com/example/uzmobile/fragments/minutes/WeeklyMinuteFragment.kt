...
class WeeklyMinuteFragment : Fragment(R.layout.fragment_weekly_minute) {
    private var _binding: FragmentWeeklyMinuteBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentWeeklyMinuteBinding.bind(view)
