...
import com.example.uzmobile.databinding.FragmentWeeklyInternetBinding
import com.example.uzmobile.databinding.FragmentWeeklyMinuteBinding
import com.example.uzmobile.fragments.HomeFragment


class WeeklyInternetFragment : Fragment(R.layout.fragment_weekly_internet) {
    private var _binding: FragmentWeeklyInternetBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentWeeklyInternetBinding.bind(view)
    ...
    private fun initList() {
        ...
        categories.add("70 MB")
        categories.add("190 MB")
        categories.add("400 MB ")
        categories.add("600 MB")
    }
