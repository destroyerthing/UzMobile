...
class MonthlyMinuteFragment : Fragment(R.layout.fragment_monthly_minute) {

    private var _binding: FragmentMonthlyMinuteBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentMonthlyMinuteBinding.bind(view)
    ...
    private fun initList() {
        ...
        categories.add("150 daqiqa")
        categories.add("160 daqiqa")
        categories.add("170 daqiqa")
        categories.add("180 daqiqa")
        categories.add("190 daqiqa ")
        categories.add("200 daqiqa")
    }
